...
start: function() {
	...
	var addEditor = function(mode) {
		...
		$("#editors").append(
			'<div class="column">' +
			'<h3 class="ui header">Editor #' + editorCount + '</h3>' +
			'<div class="ui tiny black button run_code">Run Code</div>' +
			'<textarea id="' + 
			editorId + 
			'" placeholder="Code goes here..." cols="80" rows="10"></textarea></div>' +
			'<div class="column">'+
			'<h3 class="ui header">Output #' + editorCount + '</h3>' +
			'<textarea id="' + outputEditorId + '" placeholder="Output will be shown here..."  cols="80" rows="10">' +
			'</textarea></div><div class="ui divider"></div>');
