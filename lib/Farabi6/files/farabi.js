...
function startFarabi(editorId) {
	...
	var runtimeHelp = {
		"rakudo"    : "<b>Rakudo</b> Perl 6, or simply Rakudo, is a compiler for the Perl 6 programming language. It runs on the Parrot virtual machine. For more information, please see <a href='http://rakudo.org/about'>here</a>",
		"niecza"    : "<b>Niecza</b> is a Perl 6 implementation focusing on optimization and efficient implementation research. It targets the Common Language Runtime (ECMA-335; implementations are 'Mono' and '.NET'). For more information, please see <a href='https://github.com/sorear/niecza/blob/master/README.pod'>here</a>",
		"perlito-6" : "<b>Perlito 6</b> is a compiler collection that implements a subset of Perl 6. For more information, please see <a href='http://perlito.org'>here</a>",
		"perlito-5" : "<b>Perlito 5</b> is a compiler collection that implements a subset of Perl 5. For more information, please see <a href='http://perlito.org'>here</a>"
	};

	$("#runtime").change(function() {
		var runtime = $(":selected", $(this)).attr('id');
		$("#help", $runDialog).html(runtimeHelp[runtime]);
	});
