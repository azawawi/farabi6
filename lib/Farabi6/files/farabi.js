...
function startFarabi(editorId) {
	...
	var runtimeHelp = {
		"rakudo"    : "Rakudo Perl 6, or simply Rakudo, is a compiler for the Perl 6 programming language. It runs on the Parrot virtual machine.<br>For more information, please see http://rakudo.org/about",
		"niecza"    : "This is 'Niecza', which is a Perl 6 implementation focusing on optimization and efficient implementation research. It targets the Common Language Runtime (ECMA-335; implementations are \"Mono\" and \".NET\"). For more information, please see https://github.com/sorear/niecza/blob/master/README.pod",
		"perlito-6" : "A compiler collection that implements a subset of Perl 6. For more information, please see http://perlito.org",
		"perlito-5" : "A compiler collection that implements a subset of Perl 5. For more information, please see http://perlito.org"
	};
